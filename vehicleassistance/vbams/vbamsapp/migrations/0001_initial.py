    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'admin'), (2, 'driver')], default=1, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('assignto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vbamsapp.driver')),
            ],
        ),
    ]
